...
class Student < ActiveRecord::Base
  ...
  def create_user_and_validate
    self.email ||="noreply" + self.admission_no.to_s + "@smartschools.pk"
    if self.new_record?
      ...
      user_record.email = self.email.blank? ? "noreply#{self.admission_no.to_s}@smartschools.pk" : self.email.to_s
